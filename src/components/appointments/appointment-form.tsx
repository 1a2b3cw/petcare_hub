...
const selectClassName =
  "flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-slate-400 focus:ring-2 focus:ring-slate-200 disabled:cursor-not-allowed disabled:opacity-50";
  ...
  return (
    <form action={action} className="space-y-6 rounded-2xl border border-slate-200 bg-white p-6">
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <label className="space-y-2 text-sm text-slate-700">
          <span className="font-medium">宠物</span>
          <select
            name="petId"
        ...
        <label className="space-y-2 text-sm text-slate-700">
          <span className="font-medium">安排员工</span>
        ...
        <label className="space-y-2 text-sm text-slate-700 md:col-span-2">
          <span className="font-medium">预约备注</span>
          <Textarea
            name="remark"
